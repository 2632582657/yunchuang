<template>
	<div class="editRules-container">
		<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
			...
			<el-form-item class="editRules-confirm-btn">
...
<script>
	...
	export default {
		...
		components: {
				render: c => c('#notice') ,// 这个路由是一个直接渲染了 router-view 标签的组件
			quillEditor
		}
	}
</script>
