<template>
    <div>
                ...
                <el-row :gutter="20">
                    <el-col :span="19">
                        <div class="grid-content bg-purple">
                            ...
                            ></el-input>
                            <el-button icon="el-icon-search" @click="getTransferCustomers(1)"></el-button>
                ...
                <el-row style="margin: 20px 0">
                    <el-col :span="24">
                        <div class="grid-content bg-purple-dark">
                            <el-button type="primary" @click="getTransferCustomers">搜索</el-button>
        ...
        <el-table
            ...
            <el-table-column align="center" prop="transferName" label="转交人" width="150"></el-table-column>
            <el-table-column align="center" prop="focusTime" label="转交时间" width="170"></el-table-column>
        ...
        <el-pagination
            ...
            @current-change="getTransferCustomers"
...
export default {
    ...
    created () {
        this.getTransferCustomers()
        this.getMyCustomerSelect()
    },
    methods: {
        // 获取我的下属客户列表
        getTransferCustomers (val) {
            ...
            this.$http({
                ...
                data:{
                    ...
                    transferTimeBegin:this.transferTime[0],
                    transferTimeEnd: this.transferTime[1],
                ...
                console.log(res)
                if (res.status === 200) {
                    this.transferCustomer = res.data.data.data
