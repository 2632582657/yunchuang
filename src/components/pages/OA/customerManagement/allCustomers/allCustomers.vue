        ...
        <el-card class="box-card">
            ...
            <div v-show="isShow">
                <el-row :gutter="20">
                    ...
                    <div class="grid-content bg-purple">
                        是否转交
                        <el-select v-model="isTransfer" placeholder="请选择">
                            <el-option
                                v-for="item in isTransferList"
                                :key="item.value"
                                :label="item.label"
                                :value="item.value"
                            ></el-option>
                ...
                <el-row style="margin: 20px 0">
                    <el-col :span="24">
                        <div class="grid-content bg-purple-dark">
                            <el-button type="primary" @click="getMySubordinateList(1)">搜索</el-button>
...
export default {
    ...
    methods: {
        ...
        getMySubordinateList (val) {
            ...
            this.$http({
                method:'POST',
                url: 'https://result.eolinker.com/7hUBFSf3c24e3ab4d7c9a88a6d8c4566a61bf0d55f38d5a?uri=/v1/crm/componet/customer/list',
                data:{
                ...
                if (res.status === 200) {
                    this.allCustomer = res.data.data.data
