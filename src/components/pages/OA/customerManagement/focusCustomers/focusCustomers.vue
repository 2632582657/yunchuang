<template>
    <div>
                ...
                <el-row :gutter="20">
                    <el-col :span="19">
                        <div class="grid-content bg-purple">
                            ...
                            ></el-input>
                            <el-button icon="el-icon-search" @click="getMyFocusCustomer(1)"></el-button>
                ...
                <el-row style="margin: 20px 0">
                    <el-col :span="24">
                        <div class="grid-content bg-purple-dark">
                            <el-button type="primary" @click="getMyFocusCustomer(1)">搜索</el-button>
        ...
        <el-pagination
            ...
            @current-change="getMyFocusCustomer"
...
export default {
    ...
    created () {
        this.getMyFocusCustomer()
        this.getMyCustomerSelect()
    },
    methods: {
        // 获取我的客户列表
        getMyFocusCustomer (val) {
