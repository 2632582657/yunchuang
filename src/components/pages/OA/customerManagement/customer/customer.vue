...
<template>
    <div>
                ...
                <el-row :gutter="20">
                    <el-col :span="19">
                        <div class="grid-content bg-purple">
                            ...
                            ></el-input>
                            <el-button icon="el-icon-search" @click="getMyCustomer(1)"></el-button>
                ...
                <el-row style="margin: 20px 0">
                    <el-col :span="24">
                        <div class="grid-content bg-purple-dark">
                            <el-button type="primary" @click="getMyCustomer(1)">搜索</el-button>
        ...
        <el-table
            ...
            <el-table-column align="center" prop="managerList[0].customerManagerName" label="客户经理" width="100"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        getMyCustomer (val = 1) {
            ...
            this.$http({
                method:'POST',
                url:'https://result.eolinker.com/7hUBFSf3c24e3ab4d7c9a88a6d8c4566a61bf0d55f38d5a?uri=/v1/crm/componet/myCustomer/list',
                data:{
