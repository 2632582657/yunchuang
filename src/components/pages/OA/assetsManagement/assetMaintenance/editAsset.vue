        ...
        getAsset(){
            this.$http({
                ...
                if(res.data.sysCode == 200 && res.data.code == 200){
                    ...
                    this.name = this.assetDetail.assetName;
                    this.number = this.assetDetail.assetNo;
                    this.typeSftion = this.assetDetail.assetModel;
                    this.unit = this.assetDetail.assetUnit;
                    this.property = this.assetDetail.assetAttributes;
                    this.type = this.assetDetail.assetType.split(",");
                    this.price = "" + this.assetDetail.assetPrice;
                    if(this.assetDetail.isExternalSale == true){
                        this.outside = 2;
                    }else{
                        this.outside = 1;
                    }
                    this.evaluateOut = "" + this.assetDetail.externalSalePrice;
                    if(this.assetDetail.isExternalSale == true){
                        this.inside = 2;
                    }else{
                        this.inside = 1;
                    }
                    this.evaluateIn = "" + this.assetDetail.employeeSalePrice;
                    if(this.assetDetail.validState == true){
                        this.valid = 1;
                    }else{
                        this.valid = 2;
                    }
                    this.remark = this.assetDetail.remark;
                    this.founder = this.assetDetail.createBy;
                    this.buildTime = this.assetDetail.createTime;
                }
            })
        },
        // 获取数据字典
